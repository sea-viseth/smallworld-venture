      ...
      <Row align="middle" justify="space-between">
        ...
        <Col className="nav-menu">
          <Row className="nav-list" gutter={60}>
            <Col>
              <Link href="/about">
                <a className={router.pathname == "/about" ? "nav-active" : ""}>
                  About
                </a>
              </Link>
            </Col>
            <Col>
              <Link href="/works">
                <a className={router.pathname == "/works" ? "nav-active" : ""}>
                  Works
                </a>
              </Link>
            </Col>
            ...
            <Col>
              <Link href="/spaces">
                <a className={router.pathname == "/spaces" ? "nav-active" : ""}>
                  Spaces
                </a>
              </Link>
            </Col>
            ...
            <Col>
              <Link href="/open-opportunities">
                <a
                  className={
                    router.pathname == "/open-opportunities" ? "nav-active" : ""
                  }
                >
                  Oppen-Opportunities
                </a>
